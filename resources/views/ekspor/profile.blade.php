<div class="modal-content" id="showEkspor">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    <div class="box-body box-profile">
                        ...
                        <h3 class="profile-username text-center">{{ $ekspor->name }}</h3>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>No. Telp </b> <a class="pull-right">{{ $ekspor->telp }}</a>
                            </li>
                            <li class="list-group-item hidden-print">
                                <b>Email</b> <a class="pull-right">{{ $ekspor->email }}</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.box-body -->
