<div class="modal-content" id="editMahasiswa">
    <?php if(!empty($mahasiswa)): ?>
        <?php echo e(Form::model($mahasiswa, ['route' => ['mahasiswa.update', $mahasiswa->id], 'method' => 'PUT', 'files' => true])); ?>

    <?php endif; ?>
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">
            <?php echo e(__('Edit Kegiatan Mahasiswa/Kompetisi')); ?>
...
</div><?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/mahasiswa/formedit.blade.php ENDPATH**/ ?>