<div class="modal-content" id="addPendaftaranBeasiswa">
    <?php echo e(Form::open(['url' => 'pendaftaran', 'files' => true])); ?>

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title">
        <?php echo e(__('Tambah Pendaftaran Beasiswa')); ?>
...
<?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/pendaftaran/formadd.blade.php ENDPATH**/ ?>