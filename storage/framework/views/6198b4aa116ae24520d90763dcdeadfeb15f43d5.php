<div class="modal-content" id="addMagang">
    <?php echo e(Form::open(['url' => 'magang', 'files' => true])); ?>

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title">
        <?php echo e(__('Tambah Magang, Pengalaman Organisasi, Kepanitiaan, Kegiatan Sosial/Volunter')); ?>
...
<?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/magang/formadd.blade.php ENDPATH**/ ?>