<div class="modal-content" id="addSkpi">
    <?php echo e(Form::open(['url' => 'skpi', 'files' => true])); ?>

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title">
        <?php echo e(__('Tambah Kegiatan SKPI')); ?>
    ...
    <div class="row">
        <div class="col-sm-10">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <?php echo Form::select('golongan_skpi_id', ['1' => 'Baru', '2' => 'Disetujui'], null, ['placeholder' => 'Pilih Capaian Prestasi', 'class' => 'form-control']); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <?php echo Form::select('status', ['1' => 'Baru', '2' => 'Disetujui'], null, ['placeholder' => 'Pilih Capaian Prestasi', 'class' => 'form-control']); ?>
...
<?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/skpi/formadd.blade.php ENDPATH**/ ?>