<div class="modal-content" id="addPelatihan">
    <?php echo e(Form::open(['url' => 'pelatihan', 'files' => true])); ?>

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title">
        <?php echo e(__('Tambah Keikutsertaan Pelatihan/ Seminar/ Workshop')); ?>
...
<?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/pelatihan/formadd.blade.php ENDPATH**/ ?>