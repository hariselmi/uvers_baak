<div class="modal-content" id="editLomba">
    <?php if(!empty($lomba)): ?>
        <?php echo e(Form::model($lomba, ['route' => ['lomba.update', $lomba->id], 'method' => 'PUT', 'files' => true])); ?>

    <?php endif; ?>
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">
            <?php echo e(__('Edit Kegiatan Lomba/Kompetisi')); ?>
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <?php echo e(Form::label('surat_lomba', 'Surat Kegiatan Lomba', ['class' => 'col-sm-3 text-right'])); ?>

                    <div class="col-sm-9">
                        <?php echo e(Form::file('surat_lomba', null, ['class' => 'form-control'])); ?>
...
</div><?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/lomba/formedit.blade.php ENDPATH**/ ?>