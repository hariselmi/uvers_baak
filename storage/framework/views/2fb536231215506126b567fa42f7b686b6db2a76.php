<div class="modal-content" id="editNonLomba">
    <?php if(!empty($nonlomba)): ?>
        <?php echo e(Form::model($nonlomba, ['route' => ['nonlomba.update', $nonlomba->id], 'method' => 'PUT', 'files' => true])); ?>

    <?php endif; ?>
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">
            <?php echo e(__('Edit Non Lomba')); ?>
...
<?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/nonlomba/formedit.blade.php ENDPATH**/ ?>