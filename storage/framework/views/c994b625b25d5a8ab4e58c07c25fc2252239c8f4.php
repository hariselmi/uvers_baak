<div class="modal-content" id="editPelatihan">
    <?php if(!empty($pelatihan)): ?>
        <?php echo e(Form::model($pelatihan, ['route' => ['pelatihan.update', $pelatihan->id], 'method' => 'PUT', 'files' => true])); ?>

    <?php endif; ?>
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">
            <?php echo e(__('Edit Keikutsertaan Pelatihan/ Seminar/ Workshop')); ?>
...
<?php /**PATH /home/n0ob/Documents/IT/Private/project/uvers/simak_uvers/resources/views/pelatihan/formedit.blade.php ENDPATH**/ ?>