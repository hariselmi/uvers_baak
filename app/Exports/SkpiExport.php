...
class SkpiExport implements FromCollection, WithHeadings
{
    public function collection()
    {
        ...
        ->where([['aktivitas.dlt',0], ['aktivitas.status',2]])
    ...
    {
        return [
            'nim', 'namamahasiswa', 'prodi', 'jenis_aktivitas', 'golongan_skpi', 'nama_kegiatan', 'peran', 'penyelenggara', 'tgl_mulai', 'tgl_selesai', 'kategori', 'jenis_kepesertaan', 'jml_peserta', 'capaian_prestasi', 'laman_penyelenggara', 'keterangan', 'file_sertifikat', 'file_foto_penghargaan', 'file_surat_tugas'
        ];
    }
}